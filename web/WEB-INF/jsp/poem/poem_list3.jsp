...
var start=<%=com.anegr.Constants.PullSize.POEM%>,count=<%=com.anegr.Constants.PullSize.POEM%>;
	 ...
	 success: function (jsonData) {
		 if (jsonData!=null && jsonData.length>0) {
			  ...
			  $(jsonData).each(function () {
			   ...
			   s = this.title + "<br>" + this.content + "<br><br>";
			   li.innerHTML = s;
			   //li.innerText = s;
			   el.appendChild(li);
			  });
...
<body onload="loaded()">
	<div id="wrapper">
		<div id="scroller">
			<ul id="thelist">
				<c:forEach items="${poemlist}" var="a" varStatus="status">
					<li>
					${a.title}<br>
					${a.content}<br><br>
					</li>
